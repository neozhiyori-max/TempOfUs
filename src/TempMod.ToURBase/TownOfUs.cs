...
namespace TownOfUs
{
    [BepInPlugin(Id, "TempOfUs", VersionString)]
    [BepInDependency(ReactorPlugin.Id)]
    [BepInDependency(SubmergedCompatibility.SUBMERGED_GUID, BepInDependency.DependencyFlags.SoftDependency)]
    [ReactorModFlags(Reactor.Networking.ModFlags.RequireOnAllClients)]
    public class TownOfUs : BasePlugin
    {
        public const string Id = "com.neozhiyori.tempofus";
        public const string VersionString = "0.5.0-dev";
        ...
        public static Sprite CreateSprite(string name)
        {
            ...
            var imageStream = assembly.GetManifestResourceStream(name)
                              ?? assembly.GetManifestResourceStream("TempOfUs.Resources.tempofus_logo.png");
            if (imageStream == null)
                throw new InvalidOperationException("tempMOD branding resource is missing from the assembly.");
