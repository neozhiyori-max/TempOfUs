...
namespace TownOfUs.Roles
{
    public abstract class Role
    {
        ...
        protected virtual string NameText(bool revealTasks, bool revealRole, bool revealModifier, bool revealLover, PlayerVoteArea player = null)
        {
            ...
            if (player != null && (MeetingHud.Instance.state == MeetingHud.MeetingStates.Proceeding ||
                                   MeetingHud.Instance.state == MeetingHud.MeetingStates.Results)) return PlayerName;
        ...
        public static Role GetRole(PlayerVoteArea area)
        {
            var player = PlayerControl.AllPlayerControls.ToArray()
                .FirstOrDefault(x => x.PlayerId == area.PlayerId);
        ...
        {
            return CurrentGameCompatibility.FindRoleBehaviour(roleType)?.IntroSound;
        }
    }
}