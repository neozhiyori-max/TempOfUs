...
namespace TownOfUs.Patches
{
    ...
    {
        // Upstream asset bundles are intentionally not redistributed; later role batches add tempMOD-owned equivalents.
        public static string[] AssetBundles = Array.Empty<string>();
