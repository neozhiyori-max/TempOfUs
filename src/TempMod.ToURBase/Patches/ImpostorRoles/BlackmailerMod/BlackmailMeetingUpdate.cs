            ...
            public static void AddBlackmail(MeetingHud __instance)
            {
                ...
                foreach (var role in blackmailers)
                {
                    ...
                    if (role.Blackmailed != null && !blackmailed.Contains(role.Blackmailed))
                    {
                        ...
                        {
                            var playerState = __instance.playerStates.FirstOrDefault(x => x.PlayerId == role.Blackmailed.PlayerId);
            ...
            public static void Postfix(MeetingHud __instance)
            {
                ...
                foreach (var role in blackmailers)
                {
                    if (role.Blackmailed != null && !blackmailed.Contains(role.Blackmailed))
                    {
                        ...
                        {
                            var playerState = __instance.playerStates.FirstOrDefault(x => x.PlayerId == role.Blackmailed.PlayerId);
                            if (__instance.state == MeetingHud.MeetingStates.NotVoted && !playerState.DidVote &&
                            ...
                            if (role.CanSeeBlackmailed(PlayerControl.LocalPlayer.PlayerId))
                            {
                                ...
                                if (__instance.state != MeetingHud.MeetingStates.Animating && role.ShookAlready == false)
                                {
