...
namespace TownOfUs.NeutralRoles.DoomsayerMod
{
    public class AddButtonDoom
    {
        ...
        private static Action Cycle(Doomsayer role, PlayerVoteArea voteArea, TextMeshPro nameText, bool forwardsCycle = true)
        {
            void Listener()
            {
                if (MeetingHud.Instance.state == MeetingHud.MeetingStates.Discussion) return;
                var currentGuess = role.Guesses[voteArea.PlayerId];
                ...
                var newGuess = role.Guesses[voteArea.PlayerId] = role.PossibleGuesses[guessIndex];
        ...
        private static Action Guess(Doomsayer role, PlayerVoteArea voteArea)
        {
            ...
            {
                if (
                    MeetingHud.Instance.state == MeetingHud.MeetingStates.Discussion ||
