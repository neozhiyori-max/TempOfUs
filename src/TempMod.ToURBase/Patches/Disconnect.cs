...
namespace TownOfUs.Patches
{
    ...
    public class DisconnectHandler
    {
        ...
        public static void Prefix([HarmonyArgument(0)] PlayerControl player)
        {
            ...
            {
                PlayerVoteArea voteArea = MeetingHud.Instance.playerStates.First(x => x.PlayerId == player.PlayerId);
                ...
                foreach (var playerVoteArea in MeetingHud.Instance.playerStates)
                {
                    ...
                    MeetingHud.Instance.ClearVote(playerVoteArea.PlayerId, true);
                }
                ...
                if (PlayerControl.LocalPlayer.Is(RoleEnum.Imitator) && !PlayerControl.LocalPlayer.Data.IsDead)
                {
                    ...
                    {
                        if (imitatorRole.ListOfActives[i].Item1 == voteArea.PlayerId)
                        {
                            index = i;
                            break;
                        }
