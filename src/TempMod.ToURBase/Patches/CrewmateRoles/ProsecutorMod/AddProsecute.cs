...
namespace TownOfUs.CrewmateRoles.ProsecutorMod
{
    public class AddProsecute
    {
        public static void UpdateButton(Prosecutor role, MeetingHud __instance)
        {
            ...
            role.Prosecute.gameObject.SetActive(!PlayerControl.LocalPlayer.Data.IsDead && !skip.DidVote && !role.StartProsecute && !role.Prosecuted && !role.Player.IsJailed());
            role.Prosecute.DidVote = skip.DidVote;
